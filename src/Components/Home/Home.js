...
const Home = () => {
  return (
    ...
    <div className='left-side'>
     ...
     <p className='section-details' style={{fontSize : "16.2px"}}>I am fluent in classics like <span style={{color : "#c770f0" , fontSize : "16.2px"}}>C++ and javascript</span></p>
     <p className='section-details' style={{fontSize : "16.2px"}}>My field of Interest's are building new  Web Technologies and Products and also in areas related to Blockchain</p>
     <p className='section-details' style={{fontSize : "16.2px"}}>
     Whenever possible, I also apply my passion for developing products with<span style={{color : "#c770f0" , fontSize : "19.2px"}}> Node.js </span>  and<span style={{color : "#c770f0"}}> <br></br>Modern Javascript Library and Frameworks  like React.js and Next.js</span>
     </p>
     </div>
     </section>
